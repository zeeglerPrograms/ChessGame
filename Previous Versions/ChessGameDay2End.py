...
def pieceIsHere(boardPosition):
    ...
    if boardPosition in squaresTaken:
        ...
        #this one shows square letter/number like a4
        #print(("|" + boardPosition + " "), end = '')
        #and this one is just blank
        print("|   ", end = '')
        ...
        for thisPiece in allPieces:
            ...
            if thisPiece.piecePosition == possibleMove:
                ...
                #otherwise its an enemy piece, and show it taking.
                    ...
                    possibleMoves.append(thisPiece.pieceName[0] + piecePosition + "x" + thisPiece.piecePosition)
...
def bishopMoves(pieceName, piecePosition):
    ...
    for possibleMove in possibleMoveList:
        ...
        #this checks if these are reasonable moves
        if(possibleMove[1] == "-"):
            continue
        else:
            if int(possibleMove[1]) < 1 or int(possibleMove[1]) > 8:
                continue
            else:    
                possibleMoves.append(possibleMove)
    return possibleMoves
#def add these together to move like a queen    
...
while whiteIsCheckMated == False and blackIsCheckMated == False and userQuit == False:
    ...
    while(moveCondition == False and userQuit == False):
        #I'd like to have 'enter 'c' to choose another piece
